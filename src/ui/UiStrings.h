...
inline const char *GAME_FILTER_HINT =
    "Nhấn [SELECT] để chuyển bộ lọc (TẤT CẢ / THẺ / CLOUD)";
...
inline const char *DISCLAIMER_SUBTITLE =
    "Xác nhận quyền sở hữu trước khi kết nối Drive";
inline const char *DISCLAIMER_SEC1_TITLE = "Phạm vi:";
inline const char *DISCLAIMER_SEC1_LINE1 =
    "RomCloud chỉ đồng bộ dữ liệu cá nhân.";
...
inline const char *DISCLAIMER_SEC2_LINE1 =
    "ROM lấy trực tiếp từ Google Drive của bạn.";
inline const char *DISCLAIMER_SEC2_LINE2 =
    "Chỉ nội dung bạn có quyền truy cập.";
inline const char *DISCLAIMER_SEC3_TITLE = "Trách nhiệm:";
inline const char *DISCLAIMER_SEC3_LINE1 =
    "Bạn chịu trách nhiệm về bản quyền ROM";
...
inline const char *WEB_CONNECT_GUIDE_TITLE =
    "KẾT NỐI TÀI KHOẢN QUA TRÌNH DUYỆT";
inline const char *WEB_CONNECT_STEP1 =
    "BƯỚC 1: Kết nối điện thoại/PC vào cùng Wi-Fi với TrimUI.";
inline const char *WEB_CONNECT_STEP2 =
    "BƯỚC 2: Mở trình duyệt (Chrome, Safari...) truy cập:";
inline const char *WEB_CONNECT_STEP3 =
    "BƯỚC 3: Trên trang web, bấm \"ĐĂNG NHẬP GOOGLE\" hoặc nhập liên kết thư "
    "mục Drive.";
inline const char *WEB_CONNECT_WAITING = "* Đang chờ kết nối từ trình duyệt...";
inline const char *WEB_CONNECT_AUTO_HINT =
    "Máy sẽ tự hoàn tất khi bạn đăng nhập thành công.";
...
inline const char *SYNC_SCANNING_GAMES =
    "Đang quét danh mục game trên Drive...";
...
inline const char *REVERSE_SYNC_TITLE = "UPLOAD LÊN DRIVE";
...
inline const char *REVERSE_SYNC_CANCELLED = "Đã hủy Upload.";
inline const char *REVERSE_SYNC_NO_GAMES = "Không có game cần tải lên.";
inline const char *REVERSE_SYNC_NOT_LINKED =
    "Chưa kết nối Drive. Vào Cài đặt để kết nối.";
inline const char *REVERSE_SYNC_BTN = "[Y] Upload";
inline const char *REVERSE_SYNC_CANCEL_BTN = "[B] Hủy";
inline const char *REVERSE_SYNC_GAMES_FOUND =
    "Tìm thấy "; // + count + " game trên thẻ"
inline const char *REVERSE_SYNC_GAMES_SUF =
    " game trên thẻ chưa có trên Cloud.";
...
inline const char *DIAG_SAFETY_VAL =
    "100% — Lưu trên thẻ nhớ (không sửa /rom, /usr, /overlay)";
...
inline const char *OTA_SUCCESS =
    "Cập nhật thành công! Nhấn [A] để khởi động lại.";
...
inline const char *OTA_VERIFYING_FILE =
    "Đang kiểm tra tính toàn vẹn tập tin...";
...
inline const char *OTA_MSG_RESTART_HINT =
    "Bản cập nhật có hiệu lực sau khi khởi động lại.";
...
inline const char *TOAST_SD_SCANNED_NO_DRIVE =
    "Đã quét thẻ (chưa kết nối Drive).";
...
inline const char *TOAST_GOOGLE_LOGIN_SUCCESS =
    "Đăng nhập Google thành công! [Y] đồng bộ.";
...
inline const char *TOAST_CONNECT_PERSONAL_DRIVE = "Kho hiện tại chỉ đọc! Hãy kết nối Drive cá nhân trong Cài đặt/Web để sao lưu.";
inline const char *TOAST_DOWNLOAD_STOPPED = "Đã dừng tải: ";
inline const char *TOAST_REMOVED_FROM_QUEUE = "Đã bỏ khỏi hàng: ";
inline const char *TOAST_GAME_ONLY_ON_DRIVE =
    "Game chưa tải về (chỉ có trên Drive).";
...
inline const char *MENU_SUB_REVERSE_SYNC =
    "Tải game từ thẻ nhớ lên Google Drive";
...
inline const char *MULTI_BATCH_QUEUE_PROMPT =
    "Thêm các game đã chọn vào hàng chờ?";
